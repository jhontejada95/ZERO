...
- 2026-06-28: Wrote the full English Medium launch article (`docs/submission/MEDIUM_ARTICLE.md`) and a 15-post X/Twitter thread (`docs/submission/X_THREAD.md`). Both include the required hackathon disclosure and hashtag.
...
- 2026-06-28: Created `docs/submission/LINKEDIN_POST.md`, an evidence-backed professional LinkedIn launch post with hackathon disclosure, organization mention guidance, Medium/live links, economic thesis, implementation proof, business model and recommended media/carousel order.
- 2026-06-28: Created the definitive `docs/submission/VIDEO_DEMO_SCRIPT_FINAL.md`: a 2:50–2:59 English demo script with on-camera hook, exact narration, second-by-second screen choreography, preloaded tab order, DynamoDB proof, role-separated workflows, Base Sepolia settlement and editing rules. This supersedes earlier draft video scripts.
- 2026-06-28: Added a professional kinetic-caption preset to the final video script: CapCut auto-captions, word-by-word emphasis, ZERO color system, safe positioning, animation timing, transcript corrections and four full-screen typography beats.
- 2026-06-29: Final reminder revealed the required bonus hashtag is `#H0Hackathon` (H + zero), not `#H01Hackathon`. Corrected all local Medium, X, LinkedIn, YouTube and Devpost materials; created `YOUTUBE_METADATA.md` and `FINAL_SUBMISSION_CHECKLIST.md`. Production `/`, `/enter` and `/api/agent-demo` were rechecked and return HTTP 200. The published Medium article still requires a manual hashtag edit.
